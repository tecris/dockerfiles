...
USER_DATA_TEMPLATE=$LIBVIRT_PATH/master-node_user_data
...
sed "s#%HOSTNAME%#$COREOS_HOSTNAME#g;s#%DISCOVERY%#$ETCD_DISCOVERY#g" $LIBVIRT_PATH/master-node_user_data > $LIBVIRT_PATH/$COREOS_HOSTNAME/openstack/latest/user_data
